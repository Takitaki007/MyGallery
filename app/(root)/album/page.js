  ...
  <>
    <section className="flex items-center justify-between py-5 px-24 gap-2">
      ...
      <div>
        ...
        <Dialog>
          <DialogTrigger className="bg-[#309898] flex items-center p-2 rounded-lg text-white"><Add size="24" color="#FFFFFF" variant="Broken"/>New Memory</DialogTrigger>
          <DialogContent>
            <DialogHeader>
              ...
              <div className="w-full">
                <form className="p-5">
                  <label className="flex items-center gap-2" htmlFor="location"><Location size="18" color="#94A3B8" variant="Broken"/> Location</label>
                  <br></br>
                  <input className="bg-[#F8FAFC] rounded-md p-2 w-full" type="text" id="location" placeholder="Enter your desired places"></input>
                  <br></br><br></br>
                  
                  <label className="flex items-center gap-2" htmlFor="date"><Calendar size="18" color="#94A3B8" variant="Broken"/>Date</label>
                  <br></br>
                  <input type="text" className="bg-[#F8FAFC] rounded-md p-2 w-full" id="date" placeholder="please choose the date"></input>
                  <br></br><br></br>
                  <label className="flex items-center gap-2" htmlFor="details"><NoteText size="18" color="#94A3B8" variant="Broken"/>Details</label><br></br>
